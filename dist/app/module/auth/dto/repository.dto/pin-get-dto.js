...
exports.getPinOutputDto = exports.getPinInputDto = void 0;
...
], getPinInputDto.prototype, "email", void 0);
class getPinOutputDto {
    pin;
}
exports.getPinOutputDto = getPinOutputDto;
__decorate([
    (0, class_validator_1.IsString)({ message: "O tipo de dado é inválido" }),
    (0, class_validator_1.IsNotEmpty)({ message: "O campo não pode ser vazio" }),
    __metadata("design:type", String)
], getPinOutputDto.prototype, "pin", void 0);
