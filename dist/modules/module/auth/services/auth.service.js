...
let AuthService = class AuthService {
    ...
    ApiBrevo;
    Encrypt;
    constructor(AuthRepository, ApiBrevo, Encrypt) {
    ...
    async registerUser(input) {
        try {
            ...
            const { encrypted, iv, authTag } = await this.Encrypt.encrypt(hashedPassword);
    ...
    async resetPassword(input) {
        try {
            ...
            const hashedPassword = await (0, bcrypt_1.hash)(input.userPassword, 10);
            const { iv, authTag, encrypted } = await this.Encrypt.encrypt(hashedPassword);
...
exports.AuthService = AuthService = __decorate([
    ...
    __param(2, (0, tsyringe_1.inject)("Encrypt")),
